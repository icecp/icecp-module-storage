...
/**
 *  Unit tests for TagMessage command
 *
 *
 */
public class TagMessageTest {
    ...
    public void throwWhenTagNameIsEmpty() throws Exception {
        ...
        new TagMessage(null, ids).onCommandMessage(mockStorageModule);
    }

    @Test
    public void throwWhenIdIsNull() throws Exception {
        exception.expect(StorageModuleException.class);
        new TagMessage(tags, null).onCommandMessage(mockStorageModule);
    }
    ...
    public void returnsTaggedVertex() throws Exception {
        ...
        when(mockStorageProvider.tag(any(),any())).thenReturn(returnedTaggedIds);

        int vertexSize = (int) new TagMessage(tags, ids).onCommandMessage(mockStorageModule);
